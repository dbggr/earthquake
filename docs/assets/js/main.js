...
var _createMap = __webpack_require__(10);
...
if (document.readyState === 'complete' || document.readyState !== 'loading' && !document.documentElement.doScroll) {
    ...
    document.addEventListener('DOMContentLoaded', _createMap2.default);
}
...
var _addMapMarker = __webpack_require__(30);

var _addMapMarker2 = _interopRequireDefault(_addMapMarker);
...
var clusterImagePath = 'https://cdn.rawgit.com/googlemaps/js-marker-clusterer/gh-pages/images/m';
...
function createMap() {
    ...
    _axios2.default.get(earthquakeURL).then(function (response) {
        var markers = [];

        // add each marker to array.
        response.data.features.forEach(function (feature) {
            markers.push((0, _addMapMarker2.default)(googleMap, feature));
        });

        var markerCluster = new MarkerClusterer(googleMap, markers, cluserOptions);
    });
}
